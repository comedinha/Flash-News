   ...
   public class en_US$ImbuingWidget_properties extends ResourceBundle
   {
      ...
      override protected function getContent() : Object
      {
         var _loc1_:Object = {
            ...
            "TOOLTIP_REMAINING_TIME":"Shows the time the imbuement is still active for. Note that the time will only decrease when the item is equipped.",
            "TITLE":"Imbue Item",
            "MESSAGE_CONFIRM_IMBUING_TITLE":"Confirm Imbuing Attempt",
            "LBL_IMBUEMENT_DURATION":"Lasts for {0} while equipped",
